...
<html>
	<head <?php language_attributes(); ?>>
		...
		<meta name="author" content="Nasruddin Shah">
	   	...
	   	<link rel="stylesheet" href="//localhost/Aliya/colorbox.css" type="text/css">
	   	<link rel="stylesheet" type="text/css" href="//localhost/Aliya/style.css">
	   	<link rel="stylesheet" type="text/css" href="//localhost/Aliya/homepage.min.css">
